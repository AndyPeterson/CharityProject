...
component {
	...
	// Module Entry Point
	this.entryPoint			= "SECAAdmin";
	// Model Namespace
	this.modelNamespace		= "SECAAdmin";
	// CF Mapping
	this.cfmapping			= "SECAAdmin";
	// Auto-map models
