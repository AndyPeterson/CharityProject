...
component {
	...
	// Module Properties
	this.title 				= "customModuleA2";
	this.author 			= "Andy Peterson";
	this.webURL 			= "http://ciacfug.org";
	this.description 		= "Custom Module A2";
	this.version			= "0.1";
	...
	// Module Entry Point
	this.entryPoint			= "customModuleA2";
	// Inherit Entry Point
	this.inheritEntryPoint 	= false;
	// Model Namespace
	this.modelNamespace		= "customModuleA2Name";
	// CF Mapping
	this.cfmapping			= "customModuleA2Mapping";
	// Auto-map models
